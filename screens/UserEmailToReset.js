...
import { useFonts } from "expo-font";
  ...
  const UserEmailToReset = ({ navigation }) => {
    ...
    const handleRegister = () => {
      const user = {
       ...
       axios
      .post("http://10.0.0.10:27017/forgotpassword", user)
      .then((response) => {
        console.log(response);
      


          navigation.navigate("EnterResetToken", { email: email }) 
...
<Image
  ...
  export default UserEmailToReset;
